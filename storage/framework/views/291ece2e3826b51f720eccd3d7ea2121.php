                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <div class="text-center py-3">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(Auth::user()->hasAnyRole(['admin', 'tecnico', 'analista']) && $proforma->estado == 'APROBADA'): ?>
                                    <a href="<?php echo e(route('informes.create', ['proforma_id' => $proforma->id])); ?>" 
                                       class="btn"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pruebaSystem\System-CIMA\application\resources\views/proformas/show.blade.php ENDPATH**/ ?>