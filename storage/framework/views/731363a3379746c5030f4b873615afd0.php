...
<div class="container-main">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1>
                    <i class="fas fa-user-plus" style="color: #2798F5;"></i>
                    Nuevo Cliente
                </h1>
            ...
            <a href="<?php echo e(route('clientes.index')); ?>" class="btn btn-outline-secondary btn-volver" style="border-radius: 30px; padding: 8px 20px;">
...
unset($__errorArgs, $__bag); ?>
                        <small class="text-muted">Nombre legal de la empresa o institución</small>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" 
                               class="form-control <?php $__errorArgs = ['persona_contacto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        <small class="text-muted">Persona responsable de la comunicación</small>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                        <small class="text-muted">Teléfono de contacto principal</small>
                    </div>
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  name="direccion" 
                                  rows="3" 
                                  placeholder="Ej: Av. Blanco Galindo KM 5, Cochabamba"><?php echo e(old('direccion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between pt-3 border-top">
                    <a href="<?php echo e(route('clientes.index')); ?>" class="btn btn-secondary" style="border-radius: 30px; padding: 10px 25px;">
                    ...
                    <button type="submit" class="btn" style="background-color: #2798F5; border-radius: 30px; padding: 10px 25px; color: white; border: none; transition: all 0.3s ease;"
                            onmouseover="this.style.backgroundColor='#1a7ac9'; this.style.transform='translateY(-2px)'; this.style.boxShadow='0 5px 15px rgba(39, 152, 245, 0.3)';"
                            onmouseout="this.style.backgroundColor='#2798F5'; this.style.transform='translateY(0)'; this.style.boxShadow='none';">
...
button[type="submit"][style*="background-color: #2798F5"] {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pruebaSystem\System-CIMA\application\resources\views/clientes/create.blade.php ENDPATH**/ ?>