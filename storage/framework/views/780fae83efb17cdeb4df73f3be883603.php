...
<body>
    ...
    <table style="width: 75%; margin: 0 auto; border-collapse: collapse; table-layout: fixed; border: 2px solid #000; font-size: 10px;">
        ...
        <tr>
            <!-- DATOS DE LA MUESTRA -->
            <td rowspan="5" style="width: 15%; border: 1px solid #000; text-align: center; vertical-align: middle; font-weight: bold; background: #f5f5f5; font-size: 9pt; font-family: 'Times New Roman', Times, serif; font-style: italic;">
            ...
            <td style="border: 1px solid #000; background: #9bd9e6;">
                <?php echo e($proforma->generarCodigoLaboratorio($n) ?? '---'); ?>
        ...
        <tr>
            ...
            <?php for($n = $m1; $n <= ($tieneM2 ? $m2 : $m1); $n++): ?>
            <td style="border: 1px solid #000; background: #9bd9e6;">
                <?php echo e(optional($proforma->fecha_emision)->format('Y-m-d') ?? '---'); ?>
        ...
        <tr>
            ...
            <td style="border: 1px solid #000; text-align: center; vertical-align: middle; font-size: 8pt; font-family: 'Times New Roman', Times, serif;">
            ...
            <td style="border: 1px solid #000; text-align: center; vertical-align: middle; font-size: 10pt; font-family: 'Times New Roman', Times, serif;">
                <?php echo e($resultados[$m1][$p->id] ?? '---'); ?>

            </td>

            <?php if($tieneM2): ?>
            <td style="border: 1px solid #000; text-align: center; vertical-align: middle; font-size: 10pt; font-family: 'Times New Roman', Times, serif;">
                <?php echo e($resultados[$m2][$p->id] ?? '---'); ?>
...
<?php /**PATH C:\Users\CORE I7\OneDrive\Escritorio\CIMA_v3_Local\resources\views/proformas/informe-resultados-pdf.blade.php ENDPATH**/ ?>