...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="AGUA" <?php echo e(old('tipo', $proforma->tipo) == 'AGUA' ? 'selected' : ''); ?>>AGUA</option>
                        ...
                        <div class="logistica-row mb-3 border p-3 rounded" id="logistica-row-<?php echo e($logIndex); ?>">
                            <div class="row align-items-center">
                                    ...
                                    <select name="logisticas[<?php echo e($logIndex); ?>][id]" class="form-select logistica-select" required>
                                        ...
                                        <?php $__currentLoopData = $logisticasMuestreo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($opt->id); ?>" data-costo="<?php echo e($opt->costo); ?>" data-categoria="<?php echo e($opt->categoria); ?>"
                                                ...
                                                <?php echo e($opt->categoria); ?> - <?php echo e($opt->descripcion); ?> (Bs. <?php echo e(number_format($opt->costo, 2)); ?>)
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-2 mb-2 mb-md-0">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">Bs.</span>
                                        <input type="text" class="form-control logistica-costo" value="<?php echo e(number_format($log->costo, 2)); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-1 text-center">
                                    <label class="form-label small">&nbsp;</label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pruebaSystem\System-CIMA\application\resources\views/proformas/edit.blade.php ENDPATH**/ ?>