...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="codigo-cell" style="width:28mm;">
                <strong><?php echo e($cfg->codigo_documento); ?></strong>
            </td>
        ...
        <tr>
            ...
            <td class="codigo-cell">
                VERSIÓN: <?php echo e($cfg->version); ?>
    ...
    <div class="checkbox-row">
        ...
        <span class="checkbox-option">
            ...
            <span class="checkbox-square">
                <?php echo e($proforma->tipo == 'CONTRATO' ? '✔' : ''); ?>
        ...
        <span class="checkbox-option">
            ...
            <span class="checkbox-square">
                <?php echo e($proforma->tipo == 'CONTRATO_MODIFICADO' ? '✔' : ''); ?>
    ...
    <table>
        ...
        <tr class="fila-superior">
            ...
            <!-- ESPACIO GRANDE -->
            <td colspan="2"><?php echo e($proforma->fecha_emision->format('Y/m/d')); ?></td>
        ...
        <tr class="fila-superior">
            ...
            <!-- ESPACIO GRANDE -->
            <td colspan="2"><?php echo e($proforma->fecha_recepcion->format('Y/m/d')); ?></td>
            ...
            <?php for($i = 0; $i < 28; $i++): ?>
                ...
                <td class="w-small vertical">
                    ...
                    <span class="vertical-text">
                        ...
                        <?php echo e($proforma->parametros[$i]->nombre ?? ''); ?>
